...
-- Задача №63 2* - Определить имена разных пассажиров, когда-либо летевших на одном и том же месте более одного раза.

-- Вариант 1
select Passenger.name 
from (
	select Passenger.name, Passenger.ID_psg
	from Passenger join Pass_in_trip on Passenger.ID_psg = Pass_in_trip.ID_psg
	group by name, Passenger.ID_psg, Pass_in_trip.place
